...
public class Operations {
	...
	public static void showStudentMarks() {
		...
		if(studlist.isEmpty()) {
			...
			String s="\t\t";
			System.out.println(s+"-----------------------------------------------------");
			System.out.printf(s+"|%5s  | %-10s | %-10s| %-6s | %-7s |%n","Id","FirstName","LastName","Marks","Grade");
			System.out.println(s+"-----------------------------------------------------");
			for (Student stud : studlist) {
				String grade=setGrade(stud.getMid().getMarks());
				System.out.printf(s+"|%5s  | %-10s | %-10s| %-6s | %-6s |%n",stud.getId(),stud.getCol1_firstName(),stud.getCol2_lastName(),stud.getMid().getMarks(),grade);
			}
			System.out.println(s+"-----------------------------------------------------\n\n");
	...
	public static void showStudentMarksbyId(int id) {
